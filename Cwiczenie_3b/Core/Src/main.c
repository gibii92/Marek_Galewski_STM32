...
uint8_t pozycja_diody = 0;
bool kierunek_w_prawo = true;
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		led_set(pozycja_diody, true);
		HAL_Delay(250);
		led_set(pozycja_diody, false);
		(kierunek_w_prawo) ? pozycja_diody++ : pozycja_diody--;
		if (pozycja_diody == 7 || pozycja_diody == 0)
